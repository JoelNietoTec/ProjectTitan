...
namespace WebAPI.Controllers.Participants
{
    ...
    [ApiController]
    public class ParticipantRelationshipsController : ControllerBase
    {
        ...
        public async Task<IActionResult> PostParticipantRelationship([FromBody] ParticipantRelationship participantRelationship)
        {
            ...
            _context.Entry(participantRelationship.RelatedParticipant).State = EntityState.Unchanged;
            _context.Entry(participantRelationship.Participant).State = EntityState.Unchanged;
            _context.Entry(participantRelationship.Type).State = EntityState.Unchanged;
            await _context.SaveChangesAsync();
