...
namespace WebAPI.Models.Participants
{
    public partial class ParticipantsContext : DbContext
    {
        ...
        public virtual DbSet<AssignmentTypes> AssignmentTypes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AlertPriority>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");
            ...
            modelBuilder.Entity<AlertReason>(entity =>
            {
            ...
            modelBuilder.Entity<AssignmentTypes>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");
            ...
            modelBuilder.Entity<SanctionedItem>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");
            ...
            modelBuilder.Entity<SanctionList>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");
