...
namespace CoreAPI.Controllers.Settings
{
    ...
    public class RelationshipTypesController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutRelationshipTypes([FromRoute] int id, [FromBody] RelationshipType relationshipTypes)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpPost]
        public async Task<IActionResult> PostRelationshipTypes([FromBody] RelationshipType relationshipTypes)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
