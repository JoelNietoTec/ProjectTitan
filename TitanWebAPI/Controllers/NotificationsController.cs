...
using TitanWebAPI.Models.Notifications;

namespace TitanWebAPI.Controllers
{
    public class NotificationsController : ApiController
    {
        private NotificationsModel db = new NotificationsModel();
        ...
        [HttpGet]
        [Route("api/notifications/last/{id}")]
        public IQueryable<Notification> GetLastNotifications(int id)
        {
            return db.Notifications.Where(x => x.ID > id);
        }
